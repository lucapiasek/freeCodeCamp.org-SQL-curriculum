...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams FULL JOIN games AS w ON teams.team_id = w.winner_id FULL JOIN games AS o ON teams.team_id = o.opponent_id WHERE o.year = 2014 OR w.year = 2014 ORDER BY name ASC;")"
